...
public class BlocksRegistrar {
    public static Block FUZZY_CARPET = Registry.register(Registries.BLOCK, Identifier.of(PrideMothsInitialize.MOD_ID, "fuzzy_carpet"),
            new FuzzyCarpetBlock(AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).sounds(BlockSoundGroup.WOOL)));
    public static BlockItem FUZZY_CARPET_ITEM = Registry.register(Registries.ITEM, Identifier.of(PrideMothsInitialize.MOD_ID, "fuzzy_carpet"),
            new BlockItem(FUZZY_CARPET, new Item.Settings()));

    public static Block MOTH_ENCLOSURE = Registry.register(Registries.BLOCK, Identifier.of(PrideMothsInitialize.MOD_ID, "moth_enclosure"),
