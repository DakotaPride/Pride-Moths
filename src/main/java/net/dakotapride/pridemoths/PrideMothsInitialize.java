...
public class PrideMothsInitialize implements ModInitializer {
	...
	public static TagKey<Block> MOTH_ENCLOSURES = TagKey.of(Registries.BLOCK.getKey(), Identifier.of("pridemoths", "moth_enclosures"));
	public static TagKey<Item> CAN_MOTH_EAT = TagKey.of(Registries.ITEM.getKey(), Identifier.of("pridemoths", "can_moth_eat"));
	public static TagKey<Item> MOTH_JARS = TagKey.of(Registries.ITEM.getKey(), Identifier.of("pridemoths", "moth_jars"));
	public static TagKey<PointOfInterestType> MOTH_HOME = TagKey.of(Registries.POINT_OF_INTEREST_TYPE.getKey(), Identifier.of("pridemoths", "moth_home"));
